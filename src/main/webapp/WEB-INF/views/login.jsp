...
<body>
	<h1 style="color:#03CF5D;font-weight:bold">로그인</h1>
	<form action="/login" method="post">
		<div>
			<input type="text" id="username" name="username" placeholder="아이디 또는 전화번호" required/><br>
	...
	<a href="/register" style="text-decoration: none;color: rgb(136, 136, 136);">회원가입</a>
